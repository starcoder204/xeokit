...
class BIMViewer extends Controller {
	...
	const annotations = new AnnotationsPlugin(this.viewer, {
        ...
        labelHTML: "<div class='annotation-label' style='background-color: {{labelBGColor}};'><div class='annotation-label-top'><img src='../images/icon-triangle-caution.svg'></img> <textarea class='annotation-title' type='text' value ='{{title}}' placeholder='Please type title...'></textarea></div><div class='annotation-label-bottom'><textarea class='annotation-desc' type='text' value = '{{description}}' placeholder='Please type detail...'></textarea></div></div>",
